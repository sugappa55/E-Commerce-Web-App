...
const Featured = () => {
  return (
    <div className='md:flex gap-4 m-4'>
        ...
        <div className="flex-1 bg-[#f5f7f7] p-8">
            <h2 className='text-3xl font-semibold text-center p-4'>FEATURED ON</h2>
            <div className="flex flex-wrap justify-center gap-4">
                {
                    featuredImages.map(img=>
                        <div key={img}>
                            <img src={img} alt={img} className="h-32 w-32 lg:h-40 lg:w-40"/>
                        </div>
                        )
                }
            </div>
